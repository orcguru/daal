...
#define OPENBLAS_SLOCAL_BUFFER_SIZE 32256
#define OPENBLAS_DLOCAL_BUFFER_SIZE 46080
#define OPENBLAS_CLOCAL_BUFFER_SIZE 25600
#define OPENBLAS_ZLOCAL_BUFFER_SIZE 23040
#define OPENBLAS_GEMM_MULTITHREAD_THRESHOLD 4
#define OPENBLAS_VERSION " OpenBLAS 0.2.16 "
